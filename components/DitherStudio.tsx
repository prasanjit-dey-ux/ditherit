    ...
    <div style={{ display: "flex", height: "100dvh", background: "var(--bg)", overflow: "hidden", position: "relative" }}>
      ...
      {isMobile && sidebarOpen && (
        <div 
          ...
          style={{ position: "absolute", inset: 0, zIndex: 90, background: "rgba(0,0,0,0.5)", backdropFilter: "blur(2px)" }} 
        />
      )}
      <div className={`sidebar${isMobile && !sidebarOpen ? " collapsed" : ""}`}
        style={{ width: 268, flexShrink: 0, background: "var(--surface)", borderRight: "1px solid var(--border)", display: "flex", flexDirection: "column", overflow: "visible", zIndex: 100 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            {hasMedia && (
              <button onClick={() => { setShowCompare(c => !c); if (!showCompare) setTab("studio"); }}
                ...
                <span className="hide-on-mobile" style={{ fontSize: 10, fontFamily: "'JetBrains Mono',monospace", color: showCompare ? "#fff" : "var(--muted)" }}>Compare</span>
              </button>
            )}
            <a href="https://github.com/prasanjit-dey-ux/ditherit" target="_blank" rel="noopener noreferrer"
              ...
              <span className="hide-on-mobile" style={{ color: "var(--text)", fontSize: 11, fontFamily: "'JetBrains Mono',monospace", fontWeight: 500 }}>GitHub</span>
              <span className="hide-on-mobile" style={{ display: "flex", alignItems: "center", gap: 3, background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 4, padding: "1px 6px" }}>
            ...
            <a href="https://x.com/Prasanjit_ui" target="_blank" rel="noopener noreferrer"
              ...
              <span className="hide-on-mobile" style={{ color: "var(--text)", fontSize: 11, fontFamily: "'JetBrains Mono',monospace", fontWeight: 500 }}>Twitter</span>
            </a>
          </div>
        </div>
